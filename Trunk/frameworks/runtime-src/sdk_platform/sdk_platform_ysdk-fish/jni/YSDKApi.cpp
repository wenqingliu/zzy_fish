...
void YSDKApi::login(ePlatform platform){
	...
	jmethodID WGLogin = env->GetStaticMethodID(s_YSDKApiClass, "login","(Lcom/tencent/ysdk/framework/common/ePlatform;)V");
	env->CallStaticVoidMethod(s_YSDKApiClass, WGLogin, jEnumObj);
...
int YSDKApi::getLoginRecord(UserLoginRet& userLoginRet){
	...
	JniGetAndSetStringField(user_id, "user_id", s_LoginRetClass, jLoginRet, userLoginRet);
...
void YSDKApi::reportEvent(unsigned char* cName, std::vector<KVPair>& cEventList, bool isRealTime){
    ...
    jmethodID method = env->GetStaticMethodID(s_YSDKApiClass,
                                              "reportUserEvent", "(Ljava/lang/String;Ljava/util/HashMap;Z)V");
