...
#define MAX_LOGIN_AWARD             30                                  //最大奖励
...
#define LEN_MACHINE_ID              33                                  //机器码长度
#define LEN_UUID                    33                                  //UUID长度
#define LEN_CRYPTO                  127                                 //令牌长度
#define LEN_DECRYPTO                64                                  //解密令牌长度
...
#define LEN_MSG_CONTENT             64                                  //最大消息内容



//其他平台
#define LEN_OPENID                  33
...
#define LEN_DESCRIBE				33									//描述长度
#define MAX_DESCRIBE				4									//最多描述
#define MAX_USER_TASK               2                                   //最大长度

//用户道具
#define LEN_PROPS_NAME				32									//道具名称
#define LEN_PROPS_DESC				128									//道具描述

/// 商品长度
#define LEN_SHOP_COUNT                                                 16      // 商品数组长度
#define LEN_SHOP_NAME                                                  64      // 商品名字长度
#define LEN_DES                                                       256      // 数组URL长度
...
#define GAME_GENRE_TIMING			0x0010								//定时赛
...
#define MS_RECORD					0x01								//记录状态
#define MS_SIGNUP					0x02								//报名状态
#define MS_HAVE_SIGNED				0x03								//已报名状态
#define MS_MATCHING					0x04								//比赛状态
#define MS_OUT						0x05								//淘汰状态

//客户端状态
#define GC_NONE                     0x00                                //没有状态
#define GC_WAIT                     0x01                                //等待启动
#define GC_GAME                     0x02                                //游戏启动
#define GC_FORCE                    0x03                                //强制关闭
...
//--------------------------------------------------------------------------------------
//区域划分
#define AREA_SECTION0_BEGAN         0                                   //游戏场区域 开始
#define AREA_SECTION0_ENDED         99                                  //游戏场区域 结束

#define AREA_SECTION1_BEGAN         100                                 //小奖赛区域 开始
#define AREA_SECTION1_ENDED         199                                 //小奖赛区域 结束

#define AREA_SECTION2_BEGAN         200                                 //小奖赛区域 开始
#define AREA_SECTION2_ENDED         299                                 //大奖赛区域 结束

#define AREA_MATCH_BEGAN            100                                 //比赛区间
#define AREA_MATCH_ENDED            299                                 //比赛区间
...
#define DEVICE_TYPE_IOS             0x20                                //IOS
...
#define PLATFORMID_NONE             0                                   //无效平台
#define PLATFORMID_VISITOR          1                                   //常规游客
...
#define TC_NULL						0									//无效配置
#define TC_CELLSCORE				1									//单位积分
#define TC_MINENTERSCORE			2									//最低进入积分
#define TC_MAXCHIP					3									//最大下注
#define TC_MAXTYPE					4									//最大配置类型
