...
struct TCP_Head
{
	struct TCP_Info						TCPInfo;							//基础结构
	struct TCP_Command						CommandInfo;						//命令信息
};
...
//发送映射
static const BYTE g_SendByteMap[256]=
{
...
//接收映射
static const BYTE g_RecvByteMap[256]=
{
