...
namespace __lb{
    ...
    public:
        Vec2 startPoint;
        Vec2 endPoint;
        Vec2 branchEndPoint;//only seed seg store this
...
public:
    ...
    void setStartAndEnd(Vec2 start,Vec2 end);
    void genLighting();
    void doJitter();
...
protected:
    ...
    Vec2 m_startPoint_parentSpace;//parent space start point
    Vec2 m_endPoint_parentSpace;//parent space end point
    Vec2 m_startPoint;//local space start point
    Vec2 m_endPoint;//local space end point
...
public:
    ...
    bool init(const std::string& filename,const Vec2&start,const Vec2&end);
    void setStartAndEnd(const Vec2&start,const Vec2&end){
        m_start=start;
        m_end=end;
    ...
    Vec2 getEnd()const{return m_end;}
    ...
    void runFlashAction();
    void runFlashActionOnce();
protected:
    Vec2 m_start;//parent space start point
    Vec2 m_end;//parent space end point
