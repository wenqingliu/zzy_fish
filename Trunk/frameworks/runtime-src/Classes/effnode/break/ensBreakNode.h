...
class CbreakSprite : public Sprite
{
public:
...
public:
    ...
    void doCrack(const Vec2&touchPoint);
...
protected:
    int getPointInRangeEqualsToTargetPoint(const Vec2&targetPoint,const vector<Vec2>&pointList,int imin,int imax,float eps);
