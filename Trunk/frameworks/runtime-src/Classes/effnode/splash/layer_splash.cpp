...
bool Clayer_splash::init(){
    ...
    Sprite* backGround=Sprite::create("demoRes/roughPaper.png");
...
void Clayer_splash::onTouchesBegan(const std::vector<Touch*>& touches, Event *unused_event)
{
    ...
    for(auto  it = touches.begin(); it != touches.end(); it++)
    {
        ...
        Vec2 loc_winSpace = touch->getLocationInView();
        Vec2 loc_GLSpace = CCDirector::sharedDirector()->convertToGL(loc_winSpace);
