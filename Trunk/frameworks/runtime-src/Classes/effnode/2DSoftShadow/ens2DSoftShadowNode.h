...
public:
    ...
    Vec2 m_end;
    Cedge(){}
    Cedge(const Vec2&start,const Vec2&end){
        m_start=start;
        m_end=end;
    }
};
...
public:
    ...
    void onDrawDebug(const Mat4 &transform, uint32_t flags){
        const Mat4&m=transform;
            ...
            ccDrawCircle(M4TransV2(m,Vec2(0,0)), m_r, 360, 30, false, 1, 1);
...
public:
    ...
    Vec2 m_leftPenumbraT;
    bool m_isRightPenumbraPoint;
    Vec2 m_rightPenumbraT;
    CPointType(){
...
protected:
    ...
    vector<Vec2> m_leftPenumbraLine;//m_leftPenumbraLine have three elements, [0] is start point, [1] is mid point, [2] is end point
    vector<Vec2> m_rightPenumbraLine;
    vector<Vec2> m_leftUmbraLine;
    vector<Vec2> m_rightUmbraLine;
    int m_leftPenumbraPointID;
    int m_rightPenumbraPointID;
    int m_leftUmbraPointID;
    int m_rightUmbraPointID;
    Vec2 m_intersectPoint;
    ClightNode *m_light;
