...
#include "ensCommon.h"
namespace_ens_begin
class Cripple_horizontalNode:public Sprite{
public:
...
protected:
    ...
    void updateRipple();
protected:
    vector<Vec2> m_surfacePointList_reduced;
    int m_reduceStep;
    vector<Vec2> m_surfacePointList;//in local space
    vector<Vec2> m_surfacePointList_back;//back up buffer
    float m_dx;
    Cmesh*m_mesh;
