...
int lua_jt_fish_FishHelperDelegate2_onBuildTrace(lua_State* tolua_S)
{
    int argc = 0;
    FishHelperDelegate2* cobj = nullptr;
    bool ok  = true;
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S,1,"FishHelperDelegate2",0,&tolua_err)) goto tolua_lerror;
#endif

    cobj = (FishHelperDelegate2*)tolua_tousertype(tolua_S,1,0);

#if COCOS2D_DEBUG >= 1
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_jt_fish_FishHelperDelegate2_onBuildTrace'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_jt_fish_FishHelperDelegate2_onBuildTrace'", nullptr);
            return 0;
        }
        cobj->onBuildTrace();
        lua_settop(tolua_S, 1);
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "FishHelperDelegate2:onBuildTrace",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_jt_fish_FishHelperDelegate2_onBuildTrace'.",&tolua_err);
#endif

    return 0;
}
int lua_jt_fish_FishHelperDelegate2_create(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S,1,"FishHelperDelegate2",0,&tolua_err)) goto tolua_lerror;
#endif
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_jt_fish_FishHelperDelegate2_create'", nullptr);
            return 0;
        }
        FishHelperDelegate2* ret = FishHelperDelegate2::create();
        object_to_luaval<FishHelperDelegate2>(tolua_S, "FishHelperDelegate2",(FishHelperDelegate2*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d\n ", "FishHelperDelegate2:create",argc, 0);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_jt_fish_FishHelperDelegate2_create'.",&tolua_err);
#endif
    return 0;
}
static int lua_jt_fish_FishHelperDelegate2_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (FishHelperDelegate2)");
    return 0;
}

int lua_register_jt_fish_FishHelperDelegate2(lua_State* tolua_S)
{
    tolua_usertype(tolua_S,"FishHelperDelegate2");
    tolua_cclass(tolua_S,"FishHelperDelegate2","FishHelperDelegate2","cc.Ref",nullptr);

    tolua_beginmodule(tolua_S,"FishHelperDelegate2");
        tolua_function(tolua_S,"onBuildTrace",lua_jt_fish_FishHelperDelegate2_onBuildTrace);
        tolua_function(tolua_S,"create", lua_jt_fish_FishHelperDelegate2_create);
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(FishHelperDelegate2).name();
    g_luaType[typeName] = "FishHelperDelegate2";
    g_typeCast["FishHelperDelegate2"] = "FishHelperDelegate2";
    return 1;
}

int lua_jt_fish_FishHelper_onBuildGroupTrace(lua_State* tolua_S)
{
    int argc = 0;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_jt_fish_FishHelper_onBuildGroupTrace'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_jt_fish_FishHelper_onBuildGroupTrace'", nullptr);
            return 0;
        }
        cobj->onBuildGroupTrace();
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "FishHelper:onBuildGroupTrace",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_jt_fish_FishHelper_onBuildGroupTrace'.",&tolua_err);
#endif
...
int lua_jt_fish_FishHelper_setDelegate2(lua_State* tolua_S)
{
    int argc = 0;
    FishHelper* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_jt_fish_FishHelper_setDelegate2'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        FishHelperDelegate2* arg0;

        ok &= luaval_to_object<FishHelperDelegate2>(tolua_S, 2, "FishHelperDelegate2",&arg0);
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_jt_fish_FishHelper_setDelegate2'", nullptr);
            return 0;
        }
        cobj->setDelegate2(arg0);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "FishHelper:setDelegate2",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_jt_fish_FishHelper_setDelegate2'.",&tolua_err);
#endif

    return 0;
}
int lua_jt_fish_FishHelper_loadGroupTrace(lua_State* tolua_S)
{
    int argc = 0;
    FishHelper* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_jt_fish_FishHelper_loadGroupTrace'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 2) 
    {
        ...
        ok &= luaval_to_int32(tolua_S, 2,(int *)&arg0, "FishHelper:loadGroupTrace");

        ok &= luaval_to_int32(tolua_S, 3,(int *)&arg1, "FishHelper:loadGroupTrace");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_jt_fish_FishHelper_loadGroupTrace'", nullptr);
            return 0;
        }
        cobj->loadGroupTrace(arg0, arg1);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "FishHelper:loadGroupTrace",argc, 2);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_jt_fish_FishHelper_loadGroupTrace'.",&tolua_err);
#endif
...
int lua_jt_fish_FishHelper_getDelegate2(lua_State* tolua_S)
{
    int argc = 0;
    FishHelper* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_jt_fish_FishHelper_getDelegate2'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_jt_fish_FishHelper_getDelegate2'", nullptr);
            return 0;
        }
        FishHelperDelegate2* ret = cobj->getDelegate2();
        object_to_luaval<FishHelperDelegate2>(tolua_S, "FishHelperDelegate2",(FishHelperDelegate2*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "FishHelper:getDelegate2",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_jt_fish_FishHelper_getDelegate2'.",&tolua_err);
#endif
...
int lua_register_jt_fish_FishHelper(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"FishHelper");
        ...
        tolua_function(tolua_S,"onBuildGroupTrace",lua_jt_fish_FishHelper_onBuildGroupTrace);
        ...
        tolua_function(tolua_S,"setDelegate2",lua_jt_fish_FishHelper_setDelegate2);
        tolua_function(tolua_S,"loadGroupTrace",lua_jt_fish_FishHelper_loadGroupTrace);
        ...
        tolua_function(tolua_S,"getDelegate2",lua_jt_fish_FishHelper_getDelegate2);
...
TOLUA_API int register_all_jt_fish(lua_State* tolua_S)
{
	...
	lua_register_jt_fish_FishHelperDelegate2(tolua_S);
